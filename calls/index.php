            ...
            <div class="content">
                ...
                <div class="rightbar col-md-4 col-sm-12">
                    ...
                    <div class="tip hidden">
                        <div class="tip__text">
                            <p class="paragraf_text">
                                ...
                                Прекратится движение по Тверской, Бульварному кольцу, Новому Арбату, Сретенке,
                                Кремлёвскому кольцу и другим центральным улицам. Троллейбусы в центре заменят
                                на дизельные автобусы. Часть маршрутов станет невыгодной и в будущем их существование
                                тоже под вопросом.
                            </p>
                        </div>
                    ...
                    <div class="tip hidden">
                        <div class="tip__text">
                            <p class="paragraf_text">
                                Они объясняют это решение тем, что троллейбусы невыгодны.
                                Это неправда — эксплуатировать троллейбус по данным Мосготранса на 15,5% дешевле, чем автобус.
                            </p>
                            <p class="paragraf_text">
                                Ещё говорят что троллейбус неповоротливый и создает помехи. На самом деле в центре города
                                проведена реконструкция контактной сети и теперь троллейбусы также манёврены, как автобусы.
                            </p>
                            <p class="paragraf_text">
                                ...
                                Также мэрия говорит, что дорого модернизировать контактную сеть. Однако, стоимость
                                модернизации составляет меньше 1% от расходов на программу благоустройства “Моя улица” в этом году.
                            </p>
                            <p class="paragraf_text">
                    ...
                    <div class="tip hidden">
                        <div class="tip__text">
                            <p class="paragraf_text">
                                Троллейбус более комфортен для поездок. В нём в отличие от автобуса не пахнет горючим,
                                он плавнее едет, электрический двигатель не создаёт вибрацию и не нагревает салон.
                            </p>
                            <p class="paragraf_text">
                    ...
                    <div class="tip hidden">
                        <div class="tip__text">
                            <p class="paragraf_text">
                                Во время движения троллейбус не производит вредных выбросов. С заменой одного троллейбуса на один
                                дизельный автобус в городскую атмосферу будут ежегодно выбрасываться 1,5 тонны угарного газа,
                                1 тонна оксида азота, пол-тонны оксидов серы и 200 килограмм твердых микрочастиц.
                            </p>
                        </div>
                        <button type="button" class="close" aria-label="Close"><span aria-hidden="true"></span></button>
                    </div>
                    ...
                    <div class="tip hidden">
                        <div class="tip__text">
                            <p class="paragraf_text">
                                ...
                                чтобы соответствовать современным мировым стандартам качества и эстетичности.
                                Кроме того, в конце 90-х — начале 2000-х годов была проведена практически полная реконструкция
                                контактной сети по всему центру Москвы. Таким образом, мэрия планирует демонтировать недавно
                                обновлённые участки сети с современным оборудованием, срок службы которого до 25 лет, а у отдельных
                                элементов — бессрочный.
                            </p>
                        </div>
                        <button type="button" class="close" aria-label="Close"><span aria-hidden="true"></span></button>
                    </div>
                    ...
                    <button class="btn btn-default ladda-button pull-right button--tips" data-style="expand-left">
                        <span class="ladda-label">О неповоротливости</span>
                    </button>
                    <div class="tip hidden">
                        <div class="tip__text">
                            <p class="paragraf_text">
                                Троллейбус объезжает без проблем машины, припаркованные на обочине с соблюдением правил.
                                А вот автотранспорт, стоящий не по правилам, является проблемой не только троллейбуса,
                                а для всего транспортного потока. Еще нужно знать, что проблема не в троллейбусе, а в его контактной сети.
                                Современная сеть, которая уже имеется в центре Москвы, позволяет троллейбусу ехать
                                с максимально разрешенной скоростью и проходить повороты на 50 км/ч. К тому же современные троллейбусы
                                имеют функцию автономного хода. С его помощью они могут отключиться от линии и проехать без сети несколько километров.
                            </p>
                        </div>
                        <button type="button" class="close" aria-label="Close"><span aria-hidden="true"></span></button>
                    </div>
                    ...
                    <div class="tip hidden">
                        <div class="tip__text">
                            <p class="paragraf_text">
                                ...
                                Листовки можно получить у Комитета себе домой и раздать их соседям, коллегам или разложить их
                                по почтовым ящикам в своем подъезде. Если хотите, я вас зарегистрирую, и с вами свяжется волонтёр из комитета,
                                чтобы принести вам листовок. Он может принести вам на подпись и обращение в мэрию и потом отправить его.
